      ...
      <div className="header-top">
        <div className="container">
          <div className="inner">
            ...
            <div className="button-wrapper" style={{ display: 'flex', gap: '.5rem', marginLeft: 'auto', alignSelf: 'flex-end' }}>
        ...
        <div className="container">
          <div className="inner">
            <div className="contact">
              <p className="address">City Hall • 115 West Bay Street • Magnolia, MS 39652 • <a href="tel:+16018765678">(601) 876-5678</a></p>
            </div>
            <div className="header-tools">
              <div className="buttons">
                <a href="https://www.cityofmagnolia.com" target="_blank" rel="noreferrer">Visit Magnolia</a>
                <a href="https://pikeinfo.com/chamber" target="_blank" rel="noreferrer">Chamber of Commerce</a>
                <a href="https://gopikems.com/" target="_blank" rel="noreferrer">Economic Development</a>
              </div>
              <ApiHealthBadge />
            </div>
          </div>
