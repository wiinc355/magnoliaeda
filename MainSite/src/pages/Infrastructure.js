        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginTop: '2rem' }}>
            {[
              ...
              <div key={i} style={{ background: '#f4f8fc', padding: '1.25rem', borderRadius: 4, textAlign: 'center', borderTop: '3px solid #0a4f90' }}>
                <div style={{ fontSize: '2rem', marginBottom: '.4rem' }}>{item.icon}</div>
                <strong style={{ color: '#0a4f90', display: 'block' }}>{item.label}</strong>
