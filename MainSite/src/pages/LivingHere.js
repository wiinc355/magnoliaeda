    ...
    <div>
      ...
      <section className="content-section living-section" style={{ paddingTop: 0 }}>
        <div className="container">
          ...
          <div style={{
            background: 'linear-gradient(135deg, #0a4f90, #083965)',
            height: 300,
            borderRadius: 4,
            display: 'flex',
            alignItems: 'center',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem', marginTop: '2rem' }}>
            {[
              ...
              <div key={i} style={{ background: '#f4f8fc', padding: '1.25rem', textAlign: 'center', borderRadius: 4, borderTop: '3px solid #0a4f90' }}>
                <div style={{ fontSize: '2rem', marginBottom: '.4rem' }}>{item.icon}</div>
                <strong style={{ color: '#0a4f90', display: 'block', marginBottom: '.2rem' }}>{item.label}</strong>
