    ...
    <div>
      ...
      <section className="content-section" style={{ paddingTop: 0 }}>
        <div className="container">
          ...
          <div style={{
            background: '#f4f8fc',
            borderTop: '4px solid #0a4f90',
            padding: '1.5rem',
            marginBottom: '2rem',
            borderRadius: 2
          }}>
            <h4 style={{ color: '#0a4f90', marginBottom: '.5rem' }}>Magnolia Industrial Park</h4>
            <p>
          ...
          <div style={{
            background: '#f4f8fc',
            borderTop: '4px solid #f7ad17',
            padding: '1.5rem',
            marginBottom: '2rem',
            borderRadius: 2
          }}>
            <h4 style={{ color: '#0a4f90', marginBottom: '.5rem' }}>Greenfield Development Sites</h4>
            <p>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', background: '#eaf2fb', borderRadius: 4 }}>
            <h4 style={{ color: '#0a4f90', marginBottom: '.5rem' }}>Contact Us About Available Sites</h4>
            <p style={{ margin: 0 }}>
