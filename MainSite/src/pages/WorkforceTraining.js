    ...
    <div>
      ...
      <section className="content-section" style={{ paddingTop: 0 }}>
        <div className="container">
          ...
          <div style={{ background: '#eaf2fb', padding: '1.5rem', borderRadius: 4, marginTop: '2rem' }}>
            <h4 style={{ color: '#0a4f90', marginBottom: '.5rem' }}>Contact Us About Workforce Solutions</h4>
            <p style={{ margin: 0 }}>
              Let us build a customized workforce solution for your business.
              Contact the Magnolia EDA at <a href="mailto:eda@cityofmagnolia-ms.gov">eda@cityofmagnolia-ms.gov</a> or
