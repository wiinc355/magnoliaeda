        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
            {[
              ...
              <div key={i} style={{ background: '#f4f8fc', padding: '1rem', textAlign: 'center', borderRadius: 4, borderTop: '3px solid #0a4f90' }}>
                <strong style={{ color: '#0a4f90', display: 'block', marginBottom: '.25rem' }}>{item.city}</strong>
