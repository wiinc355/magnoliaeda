  ...
  return (
    <div>
      ...
      <section className="content-section" style={{ paddingTop: 0 }}>
        <div className="container">
          <h4 style={{ color: '#0a4f90', fontSize: '1.25rem', marginBottom: '1.5rem' }}>Staff</h4>
      ...
      <section className="content-section" style={{ paddingTop: 0 }}>
        <div className="container">
          <h4 style={{ color: '#0a4f90', fontSize: '1.25rem', marginBottom: '1.5rem' }}>Board of Directors</h4>
          <div className="staff-grid">
            {BOARD.map((b, i) => (
              <div key={i} className="staff-card">
                <h4>{b.name}</h4>
          ...
          <div style={{ marginTop: '2.5rem', padding: '1.5rem', background: '#f4f8fc', borderLeft: '4px solid #0a4f90', borderRadius: 2 }}>
            <h4 style={{ color: '#0a4f90', marginBottom: '.5rem' }}>Board Meeting Minutes</h4>
